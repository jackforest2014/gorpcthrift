...
type SharedStruct struct {
  Key int32 `thriftRPC:"key,1" db:"key" json:"key"`
  Value string `thriftRPC:"value,2" db:"value" json:"value"`
}
...
type SharedServiceGetStructResult struct {
  Success *SharedStruct `thriftRPC:"success,0" db:"success" json:"success,omitempty"`
}
