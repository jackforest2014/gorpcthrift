...
//  - Comment
type Work struct {
  Num1 int32 `thriftRPC:"num1,1" db:"num1" json:"num1"`
  Num2 int32 `thriftRPC:"num2,2" db:"num2" json:"num2"`
  Op Operation `thriftRPC:"op,3" db:"op" json:"op"`
  Comment *string `thriftRPC:"comment,4" db:"comment" json:"comment,omitempty"`
}
...
type InvalidOperation struct {
  WhatOp int32 `thriftRPC:"whatOp,1" db:"whatOp" json:"whatOp"`
  Why string `thriftRPC:"why,2" db:"why" json:"why"`
}
...
type CalculatorAddResult struct {
  Success *int32 `thriftRPC:"success,0" db:"success" json:"success,omitempty"`
}
...
type CalculatorCalculateArgs struct {
  Logid int32 `thriftRPC:"logid,1" db:"logid" json:"logid"`
  W *Work `thriftRPC:"w,2" db:"w" json:"w"`
}
...
type CalculatorCalculateResult struct {
  Success *int32 `thriftRPC:"success,0" db:"success" json:"success,omitempty"`
  Ouch *InvalidOperation `thriftRPC:"ouch,1" db:"ouch" json:"ouch,omitempty"`
}
